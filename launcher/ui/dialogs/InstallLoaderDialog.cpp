...
QList<BasePage*> InstallLoaderDialog::getPages()
{
    return { // NeoForge
             ...
             new InstallLoaderPage("org.legacyfabric.fabric-loader", "fabricmc", tr("Legacy Fabric"), {}, profile),
             new InstallLoaderPage("org.babric.fabric-loader", "fabricmc", tr("Babric"), {}, profile),
             new InstallLoaderPage("org.betterthanadventure.babric", "fabricmc", tr("Better Than Adventure"), {}, profile),
             new InstallLoaderPage("net.ornithemc.loader", "fabricmc", tr("Ornithe"), {}, profile),
             new InstallLoaderPage("io.github.rift", "forge", tr("Rift"), {}, profile),
             new InstallLoaderPage("com.cleanroommc.cleanroom", "forge", tr("Cleanroom"), Version("1.12.2"), profile),
             new InstallLoaderPage("com.unascribed.nilloader", "default", tr("NilLoader"), {}, profile),
             new InstallLoaderPage("org.mcphackers.cursed-fabric-loader", "fabricmc", tr("Cursed Fabric"), {}, profile),
             new InstallLoaderPage("com.fox2code.foxloader", "default", tr("FoxLoader / ReIndev"), {}, profile),
             new InstallLoaderPage("net.xiaoyu233.fml", "default", tr("FishModLoader / MITE"), {}, profile)
    };
}
